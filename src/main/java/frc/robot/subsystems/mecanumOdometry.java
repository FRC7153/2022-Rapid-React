...
public class mecanumOdometry {
    ...
    public mecanumOdometry(
        ...
        MecanumDriveWheelPositions mecWheelPositions = new MecanumDriveWheelPositions(0.0, 0.0, 0.0, 0.0);
    ...
    public Pose2d update() {
        ...
        //return pose;
        // TODO this is safety error
        DriverStation.reportWarning("Mecanum odometry is no longer implemented (2023)", false);
    ...
    public void reset() {
        ...
        DriverStation.reportWarning("Odometry no longer implemented (2023)", false);
    }
}