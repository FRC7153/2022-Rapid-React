...
*/
  ...
  private Joystick DriveJoy = new Joystick(0);
  private Joystick spinJoy = new Joystick(1);
  ...
  private maxSpeed speedAdjust = new maxSpeed(0, 0.4, 0.9);//was .8
  private maxSpeed shooterSpeed = new maxSpeed(1, 0.89, 0.2);
  ...
  public JoystickButton autoCenterBttn = new JoystickButton(spinJoy, 2);
...
*/
  ...
  public void teleopPeriodic() {
    ...
    if (autoCenterBttn.getAsBoolean()) {
      ...
      m_robotDrive.driveCartesian(
        ...
        speedAdjust.applyMaxSpeed(
          ...
          (Math.abs(spinJoy.getZ()) < 0.12) ? 0.0 : -spinJoy.getZ()
          //DriveJoy.getTwist()
        )
      );
    }
    ...
    private GenericEntry testSpeedEntry = Shuffleboard.getTab("Shoot Test").add("Speed RPM", 0.0).getEntry();
